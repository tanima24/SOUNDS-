...
<body>
<section class="add">
   <button class="button button3"><a href="http://localhost/project/DeleteAlbum1.php">Back</a></button> <br><br>
 <?php
include('connection.php');
echo"<center>";

$album_name=$_GET['album_name'];
mysqli_query($db,"delete from search where album_no in (select album_no from album where album_name like '$album_name');");
$q= mysqli_query($db,"delete from album where album_name like '$album_name';");
