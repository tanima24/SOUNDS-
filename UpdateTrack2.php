...
<body>
<section class="add">
    <button class="button button3"><a href="http://localhost/project/UpdateTrack1.php">Back</a></button>
<br><br>
<?php
include('connection.php');
$t_name=$_GET['t_name'];
$newt_name=$_GET['newt_name'];
$type=$_GET['type'];
echo"<center>";
    $up="update track set t_name='$newt_name',type='$type' where t_name like '$t_name';";
    $q2=mysqli_query($db,$up);
    $s2=mysqli_query($db,"select * from track;");
	echo"<fieldset>";
    echo "<h2> Update Track Table:</h2>";
    echo "<table border=5";
