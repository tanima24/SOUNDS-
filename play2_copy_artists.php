...
session_start();
	...
	<div class='container'>
		...
		if($m3[1]=='Audio')
	   {
	    ...
	    echo '<a class="album-poster" href="play_audio_artist.php?tname='.$m3[0].' ">'.'<img src="http://localhost/project/'.$m3[0].'.jpg"></img><h4>'.$m3[0].'</h4></div>';
	   ...
	   else
	   {
	    ...
	    echo '<a class="album-poster" href="play_big_artist.php?tname='.$m3[0].' ">'.'<img src="http://localhost/project/'.$m3[0].'.jpg"></img><h4>'.$m3[0].'</h4></div>';
