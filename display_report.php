...
echo "<th>Logout time</th></tr>";

while(($n=mysqli_fetch_array($s))!=null)
{
echo "<tr><td style=text-align:center>".$n['r_id']."</td>";
echo "<td style=text-align:center>".$n['id']."</td>";
echo "<td style=text-align:center>".$n['intime']."</td>";
echo "<td style=text-align:center>".$n['outtime']."</td></tr>";
//$arno=$n['a_id'];
}
echo "</table><br><br>";
echo"</fieldset>";
