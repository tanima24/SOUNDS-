...
echo "<table border=5";
echo "<tr><th>Track id</th>";
echo "<th>Track name</th>";
echo "<th>Type</th></tr>";

while(($n=mysqli_fetch_array($s))!=null)
{
echo "<tr><td style=text-align:center>".$n['t_id']."</td>";
echo "<td style=text-align:center>".$n['t_name']."</td>";
echo "<td style=text-align:center>".$n['type']."</td></tr>";
//$arno=$n['a_id'];
}
echo "</table><br><br>";
echo"</fieldset>";
